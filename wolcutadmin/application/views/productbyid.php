					...
					<div class="m-portlet__body">	
			            ...
			            <div class="m-form__section m-form__section--middle">
							...
							<div class="m-form__group form-group row">
								...
								<div class="col-lg-6">
									<textarea type="text" class="form-control m-input" name="p_desc" placeholder="" ><?php echo $p_desc;?></textarea>
								</div>
							</div>
							<div class="m-form__group form-group row">
							...
							<div class="m-form__group form-group row">
								...
								<div class="col-lg-2">
									<input type="number" class="form-control m-input" style="display: none;" name="p_mstock" placeholder="" value="<?php echo $p_mstock;?>">
								</div>
							</div>
							...
							<div class="m-form__group form-group row">
							<div class="col-lg-8 ">
	      									<img src="<?php echo base_url(); ?>../uploads/product/thumb/<?php echo $p_image; ?>" class="img-responsive center-block" style="height
	      									:100px;">
